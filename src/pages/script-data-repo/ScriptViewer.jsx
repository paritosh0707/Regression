    ...
    <div className="card-base p-5 space-y-4">
      <div className="flex items-start justify-between">
        <div>
          ...
          <span className="text-[11px] text-placeholder font-mono">{script.repoPath}</span>
        </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-[12px]">
        <div className="flex items-center gap-2">
          ...
          <div>
            <span className="text-[10px] text-placeholder block">Branch</span>
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <span className="text-[10px] text-placeholder block">Version</span>
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <span className="text-[10px] text-placeholder block">Updated</span>
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <span className="text-[10px] text-placeholder block">Source</span>
      ...
      {linkedTest && (
        <div>
          <h4 className="text-xs font-semibold text-[#4C4C4C] uppercase tracking-wide mb-2">Script Content</h4>
          <pre
      ...
      {/* Change History */}
      <div>
        <h4 className="text-xs font-semibold text-[#4C4C4C] uppercase tracking-wide mb-2">Change History</h4>
          ...
          {script.changeHistory.map((ch, i) => (
            <div key={i} className="flex items-start gap-3 p-2 rounded-lg hover:bg-mutedBg">
              ...
              <div className="flex-1 min-w-0">
                ...
                <span className="text-[11px] text-placeholder flex items-center gap-1 mt-0.5">
