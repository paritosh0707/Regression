...
export default function AgenticEnginePage() {
  ...
  return (
    <div className="space-y-5 animate-fadeIn">
      <div>
        <h1 className="ds-h1">Agentic Regression Engine</h1>
        <p className="text-[12px] font-medium text-placeholder mt-0.5">Validate, enrich, and integrate approved candidates into governed regression assets</p>
      </div>

      {/* KPIs */}
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <KpiCard title="In Pipeline" value={integrationSummary.totalSelected} icon={Activity} color="#007AFF" />
        <KpiCard title="Newly Added" value={integrationSummary.newlyAdded} icon={ArrowRight} color="#388E3C" />
        <KpiCard title="Duplicates Found" value={me.duplicateCandidates} icon={Copy} color="#D32F2F" />
        <KpiCard title="Files Touched" value={me.repoFilesTouched} icon={FileCode2} color="#e65100" />
      </div>
      ...
      {activeTab === 'pipeline' && (
        <div className="space-y-4">
          ...
          <div className="card-base p-5">
            <h3 className="ds-h3 mb-3">Pipeline Status</h3>
      ...
      {activeTab === 'maintenance' && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className="card-base p-5 space-y-4">
            <h3 className="ds-h3">Regression Estate Impact</h3>
            <div className="space-y-3">
              <ImpactRow icon={ShieldAlert} label="Existing Tests Affected" value={me.affectedExisting} color="#D32F2F" />
              <ImpactRow icon={AlertTriangle} label="Obsolete Tests" value={me.obsoleteTests} color="#e65100" />
            ...
            <div className="pt-3 border-t border-borderSoft">
              <span className="text-[12px] text-placeholder">Suite Composition Impact</span>
          ...
          <div className="space-y-4">
            <div className="card-base p-5">
              <h3 className="ds-h3 mb-3">Flakiness Indicators</h3>
            ...
            <div className="card-base p-5">
              <h3 className="ds-h3 mb-3">Coverage Tag Changes</h3>
              <div className="space-y-2">
